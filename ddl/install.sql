...
CREATE FUNCTION JsonQuery AS LANGUAGE 'C++' NAME 'JsonQueryLongFactory' LIBRARY JsonLib NOT FENCED;
CREATE FUNCTION JsonQueryString AS LANGUAGE 'C++' NAME 'JsonQueryStringLongFactory' LIBRARY JsonLib NOT FENCED;
CREATE FUNCTION JsonQueryUnquoted AS LANGUAGE 'C++' NAME 'JsonQueryUnquotedLongFactory' LIBRARY JsonLib NOT FENCED;
